package com.athzaq.todolistapp.list
...
import com.athzaq.todolistapp.databinding.FragmentListBinding
import com.athzaq.todolistapp.fragment.SharedViewModel
import com.athzaq.todolistapp.list.adapter.ListAdapter
import com.athzaq.todolistapp.utils.hideKeyboard
...
class ListFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.menu_delete -> confirmRemoveAll()
